...
SEVERITY_SUMMARY_PATH = (
    ANALYTICS_DIR / "severity_summary.csv"
)

HOURLY_SUMMARY_PATH = (
    ANALYTICS_DIR / "hourly_summary.csv"
)

TIME_PERIOD_SUMMARY_PATH = (
    ANALYTICS_DIR / "time_period_summary.csv"
)

DAY_SUMMARY_PATH = (
    ANALYTICS_DIR / "day_summary.csv"
)

WEATHER_SUMMARY_PATH = (
    ANALYTICS_DIR / "weather_summary.csv"
)

LIGHTING_SUMMARY_PATH = (
    ANALYTICS_DIR / "lighting_summary.csv"
)

CAUSE_SUMMARY_PATH = (
    ANALYTICS_DIR / "cause_summary.csv"
)
